        ...
        <div className="flex flex-col gap-[3rem] w-full h-fit py-2 my-4 border-t-2">
            ...
            <div className="w-[70%] mx-auto">
                <div className="flex justify-between items-center">
                    ...
                    <img alt="image3" src="https://img.freepik.com/free-photo/brunette-smiling-doctor-uniform-looking-x-ray-image_171337-5821.jpg?w=1060&t=st=1706223764~exp=1706224364~hmac=67e37d23f48db55e4acd8483a8b89f09438dac1a5d0530b01880bf01a1cbc1db" className="w-[360px] h-[420px]" />
                </div>
            </div>
            <div className="w-[70%] mx-auto">
                <div className="flex flex-row-reverse items-center justify-between">
                    ...
                    <img alt="image1" src="https://img.freepik.com/free-photo/close-up-researcher-working-with-microscope_23-2148882102.jpg?w=1060&t=st=1706223955~exp=1706224555~hmac=f2adc1d6ae7295716e5b4fab6bf50b729540994088a71ea5822efa0d967bb38e" className="w-[360px] h-[360px]" />
                </div>
            </div>
            <div className="w-[70%] mx-auto">
                <div className="flex  justify-between items-center">
                    ...
                    <img alt="image2" src="https://img.freepik.com/free-photo/cropped-photo-boy-s-shoulder-with-stick-bandaid-vaccination_1157-51964.jpg?w=1060&t=st=1706224076~exp=1706224676~hmac=98456c25cb2aa3a56d79c810328b345f7776b5883b62b878c334c837a23b4468" className="w-[360px] h-[360px]" />
                </div>
            </div>
        </div>
    )
