...
const About = (props) => {
    ...
    return (
        <div className='w-full min-h-[200px] bg-midBlue py-2'>
            <div className='flex max-w-[1200px] justify-around items-center h-full mx-auto'>
                {/* Children */}
                {
                    isLoggedIn &&
                    <Link to="/blogs" className=' h-full w-[33%]'>
                ...
                {
                    !isLoggedIn &&
                    <Link to="/login" className='  h-full w-[33%]'>
                        <div className='border-r-2  border-darkGreen mt-6 p-2'>
                            <h2 className='text-[1.2rem] font-bold text-blue uppercase text-center'>Children</h2>
                            <div className='w-[50px] h-[5px] bg-darkGreen mb-4 relative left-[50%] translate-x-[-50%] mt-1'></div>
                            <p>
...

                {
                    ...
                    <Link to="/blogs" className='  h-full w-[33%]'>
                        <div className='mt-6 p-2'>
                            ...
                            <div className='w-[50px] h-[5px] bg-darkGreen mb-4 relative left-[50%] translate-x-[-50%] mt-1'></div>
                            <p className='p-1'>"Empower your golden years with dedicated healthcare. Tailored check-ups, preventive measures, and compassionate support ensure a healthy and fulfilling life for elderly gentlemen. Prioritize well-being with us."
                            </p>
                        </div>
                    </Link>
                }
